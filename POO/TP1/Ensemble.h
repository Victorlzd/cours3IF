...
class Ensemble
{
	...
	//Mode d'emploi :
	//Modifie la taille de l'ensemble de la valeur de delta (si delta < 0, la taille de l'ensemble diminue)
	//Contrat :
	//tailleAct <= tailleMax
	...
	//Ajoute les elements spÃ©cifiÃ©s dans le tableau Ã  l'ensemble et les trie par ordre croissant
	//DÃ©finit les caractÃ©ristiques de l'ensemble
	//Contrat :
